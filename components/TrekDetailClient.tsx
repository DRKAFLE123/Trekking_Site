        ...
        <div className="max-w-[1240px] mx-auto px-4 md:px-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-5">
            ...
            <div className="flex items-center gap-2.5 relative shrink-0">
              ...
              <a href={`/api/brochure/${trek.slug}`} download className="bg-[#2E7D32] hover:bg-[#1B5E20] text-white px-4 py-2 rounded-xl text-xs font-bold transition flex items-center gap-1.5 shadow-sm hover:shadow-md"><FaDownload /> PDF Brochure</a>
            </div>
          </div>
