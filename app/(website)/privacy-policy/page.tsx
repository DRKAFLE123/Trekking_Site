...
export const metadata: Metadata = {
  title: "Privacy Policy | Nature Heaven Trekking & Expedition",
  description:
    "Read the Privacy Policy of Nature Heaven Trekking & Expedition to understand how we collect, use, protect, and handle your personal data.",
};
...
function parsePrivacyContent(content: any) {
...
export default async function PrivacyPolicyPage() {
    ...
    return (
      <div className="bg-[#fcfbfa] min-h-screen pt-24 md:pt-32 pb-16 flex items-center justify-center">
        <div className="text-center">
          <h1 className="font-serif text-3xl font-bold text-primary mb-4">Privacy Policy</h1>
          <p className="text-charcoal/80">
            Please ensure the Privacy Policy is seeded in the CMS admin panel.
          </p>
        </div>
      </div>
    );
  ...
  const { introNodes, sections } = parsePrivacyContent(page.content);
  ...
  return (
    <div className="bg-[#f8f5f0] min-h-screen pb-20">
      ...
      <div className="relative h-[300px] md:h-[400px] w-full bg-[#1a2e1f]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 pt-24 md:pt-32">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full text-white/90 text-xs font-bold uppercase tracking-widest mb-4 border border-white/20">
            <FaShieldAlt className="text-[#c8922a]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        {/* Last Updated Banner */}
        <div className="bg-blue-50 border border-blue-100 rounded-xl px-5 py-3 mb-8 flex items-center gap-3">
          <FaShieldAlt className="text-blue-400 shrink-0" />
          <p className="text-sm text-blue-700 font-sans">
            <span className="font-bold">Your privacy matters.</span> This policy explains how we collect,
            use, and protect your personal information in compliance with applicable data protection laws.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1 flex flex-col gap-8">
            ...
            {/* Accordion Sections */}
            {sections.length > 0 && <PrivacyAccordion sections={sections} />}
            ...
            {page.documents && page.documents.length > 0 && (
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                <h3 className="font-serif text-xl md:text-2xl font-bold text-[#1a2e1f] mb-6 flex items-center gap-2">
                  <FaInfoCircle className="text-[#c8922a]" /> Downloadable Documents
                </h3>
            ...
            {/* Contact Info Card */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
              <h3 className="font-serif text-xl font-bold text-[#1a2e1f] mb-4 flex items-center gap-2">
                <FaCompass className="text-[#c8922a]" /> Questions About This Policy?
              </h3>
              <p className="text-sm text-[#4A4A4A] mb-4 font-sans leading-relaxed">
                If you have any questions, concerns, or requests regarding this Privacy Policy or how we
                handle your personal information, please reach out to us directly.
              </p>
              <div className="flex flex-col gap-2 text-sm font-sans text-[#4A4A4A]">
                <a
                  href="mailto:info@naturehaventrekking.com"
                  className="flex items-center gap-2 text-[#c8922a] font-semibold hover:text-[#b07820] transition"
                >
                  <FaEnvelope className="shrink-0" /> info@naturehaventrekking.com
                </a>
              </div>
            </div>
          </div>
